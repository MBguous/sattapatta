...
<table class="table table-striped table-hover" id="user-details-table">
	<tr>
		<th>Username</th>
		<td>
			<a href="#" id="username" data-type="text" data-title="Enter username" class="editable-click">
				{{ $user->username }}
			</a>
		</td>
	</tr>
	<tr>
		<th>Email</th>
		<td>
			<a href="#" id="email" data-type="text" data-title="Enter email" class="editable-click">
				{{ $user->email }}			
			</a>
		</td>
	</tr>
	<tr>
		<th>First Name</th>
		<td>
			<a href="#" id="firstName" data-type="text" data-title="Enter first name" class="editable-click">
				{{ $user->firstName }}			
			</a>
		</td>
	</tr>
	<tr>
		<th>Last Name</th>
		<td>
			<a href="#" id="lastName" data-type="text" data-title="Enter last name" class="editable-click">
				{{ $user->lastName }}			
			</a>
		</td>
	</tr>
	<tr>
		<th>Gender</th>
		<td>
			<a href="#" id="gender" data-type="select" data-title="Select gender" class="editable-click"></a>
	...
	<tr>
		<th>Phone</th>
		<td>
			<a href="#" id="phone" data-type="tel" data-title="Enter phone" data-value="" class="editable-click editable-empty">
				@if($user->phone == NULL)
					Empty
				@else
					{{ $user->phone }}
	...
	<tr>
		<th>Address</th>
		<td>
			<a href="#" id="address" data-type="text" data-title="Enter address" data-value="" class="editable-click editable-empty">
	...
	<tr>
		<th>Country</th>
		<td>
			<a href="#" id="country" data-type="text" data-title="Enter country" class="editable-click editable-empty">
