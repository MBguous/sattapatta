    ...
    app.BrainSocket.Event.listen('generic.event',function(msg){
        ...
        if (msg.client.data.chatroom_id == chatRoomId) {
            ...
            if(msg.client.data.user_id == user_id){
                $('#chat-log').prepend('<div class="row"><li><img src="http://sattapatta.com/'+photoUrl+'" class="img-circle" width="26"><strong>'+msg.client.data.username+'</strong><div class="message">'+msg.client.data.message+'</div></li></div>');
            }else{
